  ...
  milestone: {
    ...
    icon: (
      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <path d="M4 22h16" />
        <path d="M10 14.66V17c0 .55-.47.98-.97 1.21C7.85 18.75 7 19.88 7 21h10c0-1.12-.85-2.25-1.97-2.79-.5-.23-.97-.66-.97-1.21v-2.34" />
  ...
  return (
    <div className="group relative flex gap-5">
      ...
      <div className="flex-1 pb-10">
        ...
        >
          {/* Emerald glow */}
          <div className="pointer-events-none absolute inset-x-0 bottom-0 h-28 bg-emerald-500/13 blur-3xl" />
          ...
          <div className="relative z-10">
            ...
            <div className="flex items-center justify-between gap-3">
              ...
              <time className="text-xs text-neutral-500 tabular-nums">
                ...
                {event.time && (
                  <span className="ml-1.5 text-neutral-600">{event.time}</span>
                )}
              </time>
            </div>
